...
/**
 * Schedules {@link ScheduleTimerTask}s for one-time future execution in a background
 * thread.
 */
public interface ScheduleTimer {
    ...
    /**
     * Releases all resources acquired by this {@link ScheduleTimer} and cancels all
